...
const HeroIndia = () => {
  ...
  // Gallery items - India tour highlights
  const tourHighlights = [
    {
      title: "5 cities in India",
      img: "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_taj_mahal_hero_1766136005349.png",
      label: "Delhi"
    },
    {
      title: "12 days",
      img: "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_jaipur_palace_1766136029999.png",
      label: "Duration"
    },
    {
      title: "heritage & culture",
      img: "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_varanasi_ghats_1766136049686.png",
      label: "Varanasi"
    },
    {
      title: "authentic cuisine",
      img: "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_food_thali_1766136071812.png",
      label: "Cuisine"
    },
    {
      title: "vibrant festivals",
      img: "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_culture_dance_1766136116701.png",
      label: "Culture"
    },
  ];
  ...
  const tourDays = [
    {
      ...
      city: "Delhi & Agra",
      images: [
        "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_taj_mahal_hero_1766136005349.png",
        "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_mumbai_gateway_1766136136059.png"
      ]
    },
    {
      day: "Days 4-7",
      city: "Jaipur",
      images: [
        "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_jaipur_palace_1766136029999.png"
      ]
    },
    {
      day: "Days 8-12",
      city: "Kerala & Goa",
      images: [
        "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_kerala_backwaters_1766136092895.png",
        "C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_varanasi_ghats_1766136049686.png"
      ]
    }
  ];
  ...
  // What's included
  const included = [
    { icon: "🗺️", title: "Guides", desc: "Expert guides who know everything about India" },
    { icon: "✈️", title: "Flights", desc: "International → Delhi\nGoa → International" },
  ...
  return (
    <div className="w-full bg-[#e8dcc4] overflow-x-hidden" ref={containerRef}>
      ...
      <section className="relative h-[100vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        >
          <img
            src="C:/Users/user/.gemini/antigravity/brain/55b578e8-dfa5-4d16-9cec-abc70ff3b7ff/india_taj_mahal_hero_1766136005349.png"
            alt="India"
        ...
        <div className="absolute top-8 left-0 right-0 z-20 px-8 flex justify-between items-center">
          ...
          >
            <span className="text-white text-sm font-bold">🇮🇳 INDIA TOURS</span>
          </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          >
            <p className="text-lg leading-relaxed text-[#2c2c2c]/70 decorative-line">
              We've planned a simple and convenient 12-day itinerary for you.
              You'll visit the best places in India - Delhi, Agra, Jaipur, Kerala, and Goa.
            </p>
            <p className="text-lg leading-relaxed text-[#2c2c2c]/70 decorative-line">
              You'll see everything you need to see, from the majestic Taj Mahal to
              the vibrant streets of Jaipur, and when you want, you can
      ...
      <footer className="py-16 bg-[#2c2c2c] text-white border-t border-white/5">
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-black">🇮🇳 INDIA TOURS</span>
          </div>
        ...
        <div className="text-center mt-12 text-white/20 text-xs">
          © 2024 INDIA TOURS. All rights reserved.
        </div>
      </footer>
    </div>
  );
