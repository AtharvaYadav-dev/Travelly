...
const HeroNew = () => {
  ...
  return (
    <div className="w-full bg-[var(--bg-primary)] overflow-x-hidden" ref={containerRef}>
      ...
      {/* 🚀 CTA SECTION */}
      <section className="py-20 md:py-32 px-4 md:px-6 bg-gradient-sunset relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-white uppercase tracking-tighter mb-6">
              Ready To Start
              <br />
              Your Journey?
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto">
              Join thousands of travelers who have discovered their perfect adventure with Travelly
            </p>
            <Magnetic>
              <button
                onClick={() => navigate('/planner')}
                className="px-12 py-6 bg-white text-black rounded-full font-black uppercase tracking-wider text-base hover:scale-105 transition-all duration-500 shadow-2xl"
              >
                Plan Your Trip Now
              </button>
            </Magnetic>
      ...
      {/* FOOTER */}
      <footer className="py-16 md:py-20 px-4 md:px-6 bg-[var(--bg-surface)] border-t border-[var(--border-color)]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              <h3 className="text-2xl font-black uppercase italic tracking-tighter text-[var(--text-primary)] mb-4">
                Travelly<span className="text-[#FF6B35]">.</span>
              </h3>
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed">
                Your AI-powered travel companion for unforgettable journeys around the world.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-[var(--text-primary)] mb-4 uppercase tracking-wider text-sm">Explore</h4>
              <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
                <li><a href="#" className="hover:text-[#FF6B35] transition-colors">Destinations</a></li>
                <li><a href="#" className="hover:text-[#FF6B35] transition-colors">Experiences</a></li>
                <li><a href="#" className="hover:text-[#FF6B35] transition-colors">Travel Guides</a></li>
                <li><a href="#" className="hover:text-[#FF6B35] transition-colors">Blog</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold text-[var(--text-primary)] mb-4 uppercase tracking-wider text-sm">Company</h4>
              <ul className="space-y-2 text-sm text-[var(--text-secondary)]">
            ...
            <div>
              <h4 className="font-bold text-[var(--text-primary)] mb-4 uppercase tracking-wider text-sm">Follow Us</h4>
              <div className="flex gap-3">
                {['Instagram', 'Facebook', 'Twitter', 'LinkedIn'].map((social, i) => (
                  <a
                    key={i}
                    href="#"
                    className="w-10 h-10 flex items-center justify-center bg-[var(--bg-card)] rounded-full hover:bg-[#FF6B35] hover:text-white transition-all duration-300"
                  >
          ...
          <div className="pt-8 border-t border-[var(--border-color)] text-center text-sm text-[var(--text-secondary)]">
            © 2024 Travelly. All rights reserved. Made with ❤️ for travelers worldwide.
          </div>
        </div>
      </footer>
    </div>
